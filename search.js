 ...
 $(document).ready(function() {
     ...
     var clipboard = new Clipboard('.btn-get_link', {
      ...
      var clipboard_billede = new Clipboard('.btn-get_billedlink', {
         text: function() {
             ...
             //UserMsgBox("body", "<div class ='content_wrapper'><h4>Du har kopieret et billede med link til objektet, som du kan sætte ind i HTML</h4><img class='img-responsive' src='" +jsonData[active_tn].meta_imgUrl+ "'><p>Linket <b><a href='" + jsonData[active_tn].meta_objUrl + "'><img src='" +jsonData[active_tn].meta_imgUrl+ "'></a></b> er nu kopieret til din udklipsholderen.</p><br/>Du kan nu indsætte linket, der hvor du skal bruge det.</div>");
             UserMsgBox("body", "<div class ='content_wrapper'><h4>Du har kopieret billedet med link til objektet!</h4><img class='img-responsive' src='" +jsonData[active_tn].meta_imgUrl+ "'><br/><p>Billedlinket er i din udklipsholder, og skal indsættes i HTML-koden der hvor du skal bruge det.<img class='kodelink' src='img/source_code.svg'></div>");
             var link = "<a href='" + jsonData[active_tn].meta_objUrl + "' target='_blank'><img src='" +jsonData[active_tn].meta_imgUrl+ "'></a>" 
             return link;
 ...
 function build_tn_grid() {
     ...
     for (var i = 0; i < jsonData.length; i++) {
         ...
         HTML += '<div class="link_container"><div class="big_link"><span class="btn btn-lg btn-default btn-link_kat"><a id="copy_href" target="_blank" href="' + jd.meta_objUrl + '">Åbn objekt </a></span> </div><div class="small_link"><a class="btn-get_link btn-link_kat"> Kopier link </a><br/> <a class="btn-get_billedlink btn-link_kat"> Kopier billedlink </a><br/> <a class="btn-get_embed btn-link_kat"> Indsæt objekt i LMS</a> </div></div>';
